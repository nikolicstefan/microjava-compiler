...
public class DesignatorBaseInstanceArr implements SyntaxNode {
    ...
    public DesignatorBaseInstanceArr (DesignatorArrName DesignatorArrName, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorBaseInstanceArr(\n");
