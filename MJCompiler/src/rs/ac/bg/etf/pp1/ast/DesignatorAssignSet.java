...
public class DesignatorAssignSet extends DesignatorAssign {
    ...
    public DesignatorAssignSet (Designator Designator, Assignop Assignop, Designator Designator1, Setop Setop, Designator Designator2) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorAssignSet(\n");
